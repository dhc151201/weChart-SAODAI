import {isChinese} from "./../../../../utils/public.tool.js"
...
/***/ function(module, exports, __webpack_require__) {
	...
	Page({
	    ...
	    onLoad: function onLoad(options) {
	        ...
	        var c = '北京';
	        var cityArr = wx.getStorageSync("history-city") || [];
	        this.setData({
	            cityArr: cityArr,
	            city: c
	        });
      ...
      onSearchInput: function(e){
        ...
        this.setData({
          ...
          var key= this.onSearchInputCall({
              e: e,
        ...
        /*
        const worker= wx.createWorker('workers/search.city.js');

        worker.postMessage({
          e: e,
          cityList: this.data.cityList
        })
        worker.onMessage( (key)=> {
          this.setData({
            searchResult: key,
            searching: false
          })
        ...
        */
	    ...
	    wxSortPickerViewItemTap: function wxSortPickerViewItemTap(e) {
          ...
          if (!this.data.cityArr.includes(city)){
            this.data.cityArr.push(city);
            wx.setStorageSync("history-city", this.data.cityArr)
          }
          this.navigateBack("/packageMap/pages/map/search/index", { choseCity: city})
	    },
